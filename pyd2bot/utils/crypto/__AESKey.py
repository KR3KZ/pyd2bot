...
class AESKey:
    ...
    _InvSbox = [82,9,106,213,48,54,165,56,191,64,163,158,129,243,215,251,124,227,57,130,155,47,255,135,52,142,67,68,196,222,233,203,84,123,148,50,166,194,35,61,238,76,149,11,66,250,195,78,8,46,161,102,40,217,36,178,118,91,162,73,109,139,209,37,114,248,246,100,134,104,152,22,212,164,92,204,93,101,182,146,108,112,72,80,253,237,185,218,94,21,70,87,167,141,157,132,144,216,171,0,140,188,211,10,247,228,88,5,184,179,69,6,208,44,30,143,202,63,15,2,193,175,189,3,1,19,138,107,58,145,17,65,79,103,220,234,151,242,207,206,240,180,230,115,150,172,116,34,231,173,53,133,226,249,55,232,28,117,223,110,71,241,26,113,29,41,197,137,111,183,98,14,170,24,190,27,252,86,62,75,198,210,121,32,154,219,192,254,120,205,90,244,31,221,168,51,136,7,199,49,177,18,16,89,39,128,236,95,96,81,127,169,25,181,74,13,45,229,122,159,147,201,156,239,160,224,59,77,174,42,245,176,200,235,187,60,131,83,153,97,23,43,4,126,186,119,214,38,225,105,20,99,85,33,12,125]
    ...
    def __init__(self, key:ByteArray):
        self.Sbox = ByteArray(self._Sbox.copy())
        self.InvSbox = ByteArray(self._InvSbox.copy())
        self.Xtime2Sbox = ByteArray(self._Xtime2Sbox.copy())
        self.Xtime3Sbox = ByteArray(self._Xtime3Sbox.copy())
        self.Xtime2 = ByteArray(self._Xtime2.copy())
        self.Xtime9 = ByteArray(self._Xtime9.copy())
        self.XtimeB = ByteArray(self._XtimeB.copy())
    ...
    def expandKey(self) -> None:
        ...
        tmp4 = 0
        idx = 0
        Nk = self.key.length // 4
        self.Nr = Nk + 6
        for idx in range(Nk, self.Nb * (self.Nr + 1)):
            tmp0 = self.key[4 * idx - 4]
            tmp1 = self.key[4 * idx - 3]
            tmp2 = self.key[4 * idx - 2]
            tmp3 = self.key[4 * idx - 1]
            
            if not (idx % Nk):
                tmp4 = tmp3
                tmp3 = self.Sbox[tmp0]
                tmp0 = self.Sbox[tmp1] ^ self.Rcon[idx // Nk]
                tmp1 = self.Sbox[tmp2]
                tmp2 = self.Sbox[tmp4]
    ...
    def invMixSubColumns(self) :
        ...
        self.tmp[15] = self.XtimeB[self.state[0]] ^ self.XtimeD[self.state[1]] ^ self.Xtime9[self.state[2]] ^ self.XtimeE[self.state[3]]
        self.tmp[4] = self.XtimeE[self.state[4]] ^ self.XtimeB[self.state[5]] ^ self.XtimeD[self.state[6]] ^ self.Xtime9[self.state[7]]
        self.tmp[9] = self.Xtime9[self.state[4]] ^ self.XtimeE[self.state[5]] ^ self.XtimeB[self.state[6]] ^ self.XtimeD[self.state[7]]
        self.tmp[14] = self.XtimeD[self.state[4]] ^ self.Xtime9[self.state[5]] ^ self.XtimeE[self.state[6]] ^ self.XtimeB[self.state[7]]
        self.tmp[3] = self.XtimeB[self.state[4]] ^ self.XtimeD[self.state[5]] ^ self.Xtime9[self.state[6]] ^ self.XtimeE[self.state[7]]
        self.tmp[8] = self.XtimeE[self.state[8]] ^ self.XtimeB[self.state[9]] ^ self.XtimeD[self.state[10]] ^ self.Xtime9[self.state[11]]
        self.tmp[13] = self.Xtime9[self.state[8]] ^ self.XtimeE[self.state[9]] ^ self.XtimeB[self.state[10]] ^ self.XtimeD[self.state[11]]
        self.tmp[2] = self.XtimeD[self.state[8]] ^ self.Xtime9[self.state[9]] ^ self.XtimeE[self.state[10]] ^ self.XtimeB[self.state[11]]
        self.tmp[7] = self.XtimeB[self.state[8]] ^ self.XtimeD[self.state[9]] ^ self.Xtime9[self.state[10]] ^ self.XtimeE[self.state[11]]
        self.tmp[12] = self.XtimeE[self.state[12]] ^ self.XtimeB[self.state[13]] ^ self.XtimeD[self.state[14]] ^ self.Xtime9[self.state[15]]
        self.tmp[1] = self.Xtime9[self.state[12]] ^ self.XtimeE[self.state[13]] ^ self.XtimeB[self.state[14]] ^ self.XtimeD[self.state[15]]
        self.tmp[6] = self.XtimeD[self.state[12]] ^ self.Xtime9[self.state[13]] ^ self.XtimeE[self.state[14]] ^ self.XtimeB[self.state[15]]
        self.tmp[11] = self.XtimeB[self.state[12]] ^ self.XtimeD[self.state[13]] ^ self.Xtime9[self.state[14]] ^ self.XtimeE[self.state[15]]
        for i in range(4 * self.Nb):
            self.state[i] = self.InvSbox[self.tmp[i]]

    def invShiftRows(self) -> None:
        tmp = 0
        self.state[0] = self.InvSbox[self.state[0]]
        self.state[4] = self.InvSbox[self.state[4]]
        self.state[8] = self.InvSbox[self.state[8]]
        self.state[12] = self.InvSbox[self.state[12]]
        tmp = self.InvSbox[self.state[13]]
        self.state[13] = self.InvSbox[self.state[9]]
        self.state[9] = self.InvSbox[self.state[5]]
        self.state[5] = self.InvSbox[self.state[1]]
        self.state[1] = tmp
        tmp = self.InvSbox[self.state[2]]
        self.state[2] = self.InvSbox[self.state[10]]
        self.state[10] = tmp
        tmp = self.InvSbox[self.state[6]]
        self.state[6] = self.InvSbox[self.state[14]]
        self.state[14] = tmp
        tmp = self.InvSbox[self.state[3]]
        self.state[3] = self.InvSbox[self.state[7]]
        self.state[7] = self.InvSbox[self.state[11]]
        self.state[11] = self.InvSbox[self.state[15]]
        self.state[15] = tmp
