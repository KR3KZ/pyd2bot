   ...
   class SoulStoneItemCriterion(ItemCriterion implements IDataCenter):
      
      ID_SOUL_STONE:list = [DataEnum.ITEM_GID_SOULSTONE,DataEnum.ITEM_GID_SOULSTONE_MINIBOSS,DataEnum.ITEM_GID_SOULSTONE_BOSS]
