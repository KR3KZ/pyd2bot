   ...
   class SpecializationItemCriterion(ItemCriterion implements IDataCenter):
      ...
      @property
      def text(self) -> str:
         readableCriterionValue:str = AlignmentRank.getAlignmentRankById(int(_criterionValue)).name
         readableCriterionRef:str = I18n.getUiText("ui.alignment.spécialization")
