...
from pyd2bot.game.fight.managers import StatsManager,EntitiesManager
from pyd2bot.game.fight import TackleUtil
...
from ..stats.entityStats import EntityStats
...
class FightReachableCellsMaker:
   ...
   def __init__(self, player:IBot, infos:GameFightFighterInformations, fromCellId:int = -1, movementPoint:int = -1):
      self.player = player
