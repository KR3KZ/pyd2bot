...
class GameFightCharacteristics:
   ...
   def initGameFightCharacteristics(self, characteristics:CharacterCharacteristics = None, summoner:float = 0, summoned:bool = False, invisibilityState:int = 0) -> 'GameFightCharacteristics':
