package com.ankamagames.dofus.network.messages.game.moderation
{
   ...
   public class PopupWarningClosedMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_PopupWarningClosedMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_PopupWarningClosedMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_PopupWarningClosedMessage(tree:FuncTree) : void
      {
      }
   }
}
