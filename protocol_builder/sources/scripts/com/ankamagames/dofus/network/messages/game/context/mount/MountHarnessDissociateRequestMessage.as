package com.ankamagames.dofus.network.messages.game.context.mount
{
   ...
   public class MountHarnessDissociateRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MountHarnessDissociateRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MountHarnessDissociateRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_MountHarnessDissociateRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
