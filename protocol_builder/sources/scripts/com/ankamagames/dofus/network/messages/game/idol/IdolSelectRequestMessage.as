package com.ankamagames.dofus.network.messages.game.idol
{
   ...
   public class IdolSelectRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public static const protocolId:uint = 5093;
      ...
      public function initIdolSelectRequestMessage(idolId:uint = 0, activate:Boolean = false, party:Boolean = false) : IdolSelectRequestMessage
      {
         this.idolId = idolId;
      ...
      public function serializeAs_IdolSelectRequestMessage(output:ICustomDataOutput) : void
      {
         var _box0:uint = 0;
      ...
      public function deserializeAs_IdolSelectRequestMessage(input:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_IdolSelectRequestMessage(tree:FuncTree) : void
      {
