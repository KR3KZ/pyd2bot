package com.ankamagames.dofus.network.messages.game.guild.application
{
   ...
   public class GuildDeleteApplicationRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_GuildDeleteApplicationRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_GuildDeleteApplicationRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_GuildDeleteApplicationRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
