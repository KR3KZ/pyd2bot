package com.ankamagames.dofus.network.messages.web.haapi
{
   ...
   public class HaapiApiKeyRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_HaapiApiKeyRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_HaapiApiKeyRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_HaapiApiKeyRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
