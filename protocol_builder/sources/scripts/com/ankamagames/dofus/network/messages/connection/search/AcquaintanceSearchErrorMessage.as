package com.ankamagames.dofus.network.messages.connection.search
{
   ...
   public class AcquaintanceSearchErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AcquaintanceSearchErrorMessage(output:ICustomDataOutput) : void
      {
      ...
      public function deserializeAs_AcquaintanceSearchErrorMessage(input:ICustomDataInput) : void
      {
      ...
      public function deserializeAsyncAs_AcquaintanceSearchErrorMessage(tree:FuncTree) : void
      {
