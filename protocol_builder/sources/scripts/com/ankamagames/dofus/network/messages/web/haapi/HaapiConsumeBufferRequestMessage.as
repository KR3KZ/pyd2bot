package com.ankamagames.dofus.network.messages.web.haapi
{
   ...
   public class HaapiConsumeBufferRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_HaapiConsumeBufferRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_HaapiConsumeBufferRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_HaapiConsumeBufferRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
