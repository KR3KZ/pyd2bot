package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class AnomalySubareaInformationRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_AnomalySubareaInformationRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_AnomalySubareaInformationRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_AnomalySubareaInformationRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
