package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class DungeonPartyFinderRegisterErrorMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_DungeonPartyFinderRegisterErrorMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_DungeonPartyFinderRegisterErrorMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_DungeonPartyFinderRegisterErrorMessage(tree:FuncTree) : void
      {
      }
   }
}
