package com.ankamagames.dofus.network.messages.game.context.roleplay
{
   ...
   public class MapRunningFightListRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_MapRunningFightListRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_MapRunningFightListRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_MapRunningFightListRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
