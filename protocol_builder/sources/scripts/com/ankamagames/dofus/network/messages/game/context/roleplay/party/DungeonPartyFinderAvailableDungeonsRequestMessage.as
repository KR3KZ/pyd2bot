package com.ankamagames.dofus.network.messages.game.context.roleplay.party
{
   ...
   public class DungeonPartyFinderAvailableDungeonsRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_DungeonPartyFinderAvailableDungeonsRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_DungeonPartyFinderAvailableDungeonsRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_DungeonPartyFinderAvailableDungeonsRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
