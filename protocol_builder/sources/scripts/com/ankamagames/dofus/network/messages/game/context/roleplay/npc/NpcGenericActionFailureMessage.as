package com.ankamagames.dofus.network.messages.game.context.roleplay.npc
{
   ...
   public class NpcGenericActionFailureMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_NpcGenericActionFailureMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_NpcGenericActionFailureMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_NpcGenericActionFailureMessage(tree:FuncTree) : void
      {
      }
   }
}
