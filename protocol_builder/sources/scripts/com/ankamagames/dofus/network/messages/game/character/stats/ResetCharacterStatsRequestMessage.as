package com.ankamagames.dofus.network.messages.game.character.stats
{
   ...
   public class ResetCharacterStatsRequestMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      public function serializeAs_ResetCharacterStatsRequestMessage(output:ICustomDataOutput) : void
      {
      }
      ...
      public function deserializeAs_ResetCharacterStatsRequestMessage(input:ICustomDataInput) : void
      {
      }
      ...
      public function deserializeAsyncAs_ResetCharacterStatsRequestMessage(tree:FuncTree) : void
      {
      }
   }
}
