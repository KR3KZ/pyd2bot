...
class SpellLevel(ICellZoneProvider, IDataCenter):
   ...
   def spell(self) -> Spell:
      if not self._spell:
         self._spell = Spell.getSpellById(self.spellId)
      return self._spell
   ...
   def canSummon(self) -> bool:
      ...
      for effect in self.effects:
         if effect.effectId == ActionIds.ACTION_CHARACTER_ADD_DOUBLE_USE_SUMMON_SLOT or effect.effectId == ActionIds.ACTION_SUMMON_SLAVE:
            return True
         if effect.effectId == ActionIds.ACTION_SUMMON_CREATURE or effect.effectId == ActionIds.ACTION_FIGHT_KILL_AND_SUMMON or effect.effectId == ActionIds.ACTION_FIGHT_KILL_AND_SUMMON_SLAVE:
