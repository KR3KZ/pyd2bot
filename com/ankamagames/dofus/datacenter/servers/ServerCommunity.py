...
class ServerCommunity(IDataCenter):
   ...
   def namingRulePresetName(self) -> NamingRule:
      if not self._namingRulePresetName:
         self._namingRulePresetName = NamingRule.getNamingRuleById(self.namingRulePresetNameId)
