from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceString import EffectInstanceString
...
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDate import EffectInstanceDate
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDice import EffectInstanceDice
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceDuration import EffectInstanceDuration
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceInteger import EffectInstanceInteger
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceLadder import EffectInstanceLadder
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceMinMax import EffectInstanceMinMax
from com.ankamagames.dofus.datacenter.effects.instances.EffectInstanceMount import EffectInstanceMount
...
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectDate import ObjectEffectDate
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectDice import ObjectEffectDice
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectDuration import ObjectEffectDuration
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectInteger import ObjectEffectInteger
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectLadder import ObjectEffectLadder
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectMinMax import ObjectEffectMinMax
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectMount import ObjectEffectMount
from com.ankamagames.dofus.network.types.game.data.items.effects.ObjectEffectString import ObjectEffectString
...
class ObjectEffectAdapter:
      ...
      def fromNetwork(self, oe:ObjectEffect) -> EffectInstance:
         ...
         if oe is ObjectEffectDice and oe.actionId == ActionIds.ACTION_INCARNATION:
            ...
            effect.month = ObjectEffectDice(oe).diceSide * 32768 + ObjectEffectDice(oe).diceConst
            level = 1
            while True:
