from com.ankamagames.dofus.network.types.game.friend.AbstractContactInformations import (
...
class AcquaintanceInformation(AbstractContactInformations):
    ...
    def init(
        self, playerState_: int, accountId_: int, accountTag_: "AccountTagInformation"
    ):
