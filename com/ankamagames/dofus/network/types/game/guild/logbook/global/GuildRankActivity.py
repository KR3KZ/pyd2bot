from com.ankamagames.dofus.network.types.game.guild.logbook.GuildLogbookEntryBasicInformation import (
    GuildLogbookEntryBasicInformation,
)
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.guild.GuildRankMinimalInformation import (
...
class GuildRankActivity(GuildLogbookEntryBasicInformation):
    ...
    def init(
        self,
        rankActivityType_: int,
        guildRankMinimalInfos_: "GuildRankMinimalInformation",
        id_: int,
        date_: int,
    ):
