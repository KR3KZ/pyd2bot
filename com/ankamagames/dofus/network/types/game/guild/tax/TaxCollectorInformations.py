...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.guild.tax.AdditionalTaxCollectorInformations import (
        AdditionalTaxCollectorInformations,
    )
    from com.ankamagames.dofus.network.types.game.look.EntityLook import EntityLook
    from com.ankamagames.dofus.network.types.game.guild.tax.TaxCollectorComplementaryInformations import (
...
class TaxCollectorInformations(NetworkMessage):
    ...
    def init(
        ...
        firtNameId_: int,
        lastNameId_: int,
        additionalInfos_: "AdditionalTaxCollectorInformations",
        worldX_: int,
        worldY_: int,
        subAreaId_: int,
        state_: int,
