...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.fight.FightTeamLightInformations import (
        FightTeamLightInformations,
    )
    from com.ankamagames.dofus.network.types.game.context.fight.FightOptionsInformations import (
...
class FightExternalInformations(NetworkMessage):
    ...
    def init(
        ...
        fightTeams_: list["FightTeamLightInformations"],
