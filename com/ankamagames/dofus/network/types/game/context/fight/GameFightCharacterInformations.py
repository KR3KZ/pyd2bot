...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.character.alignment.ActorAlignmentInformations import (
        ActorAlignmentInformations,
    )
    from com.ankamagames.dofus.network.types.game.character.status.PlayerStatus import (
        PlayerStatus,
    )
    ...
    from com.ankamagames.dofus.network.types.game.context.fight.GameFightCharacteristics import (
