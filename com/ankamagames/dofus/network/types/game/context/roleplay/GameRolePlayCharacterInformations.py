...
if TYPE_CHECKING:
    ...
    from com.ankamagames.dofus.network.types.game.context.roleplay.HumanInformations import (
        HumanInformations,
    )
...
class GameRolePlayCharacterInformations(GameRolePlayHumanoidInformations):
    ...
    def init(
        ...
        super().__init__(
            humanoidInfo_, accountId_, name_, look_, contextualId_, disposition_
        )
