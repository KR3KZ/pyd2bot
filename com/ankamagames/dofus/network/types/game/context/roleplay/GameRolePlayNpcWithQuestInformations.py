from com.ankamagames.dofus.network.types.game.context.roleplay.GameRolePlayNpcInformations import (
    GameRolePlayNpcInformations,
)
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.quest.GameRolePlayNpcQuestFlag import (
...
class GameRolePlayNpcWithQuestInformations(GameRolePlayNpcInformations):
    ...
    def init(
        ...
        super().__init__(
            npcId_, sex_, specialArtworkId_, look_, contextualId_, disposition_
        )
