...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryPlayerInfo import (
        JobCrafterDirectoryEntryPlayerInfo,
    )
    from com.ankamagames.dofus.network.types.game.context.roleplay.job.JobCrafterDirectoryEntryJobInfo import (
...
class JobCrafterDirectoryListEntry(NetworkMessage):
    ...
    def init(
        ...
        jobInfo_: "JobCrafterDirectoryEntryJobInfo",
    ):
