...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.fight.arena.ArenaRanking import (
        ArenaRanking,
    )
    from com.ankamagames.dofus.network.types.game.context.roleplay.fight.arena.ArenaLeagueRanking import (
        ArenaLeagueRanking,
    )
...
class ArenaRankInfos(NetworkMessage):
    ...
    def init(
        self,
        ranking_: "ArenaRanking",
        leagueRanking_: "ArenaLeagueRanking",
        victoryCount_: int,
        fightcount_: int,
        numFightNeededForLadder_: int,
    ):
