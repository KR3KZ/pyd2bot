...
class ExtendedBreachBranch(BreachBranch):
    ...
    def init(
        self,
        rewards_: list["BreachReward"],
        modifier_: int,
        prize_: int,
        room_: int,
        element_: int,
        bosses_: list["MonsterInGroupLightInformations"],
        map_: int,
        score_: int,
        relativeScore_: int,
        monsters_: list["MonsterInGroupLightInformations"],
    ):
        ...
        super().__init__(
            room_, element_, bosses_, map_, score_, relativeScore_, monsters_
        )
