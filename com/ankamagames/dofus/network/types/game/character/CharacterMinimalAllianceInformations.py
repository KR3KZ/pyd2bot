from com.ankamagames.dofus.network.types.game.character.CharacterMinimalGuildInformations import (
    CharacterMinimalGuildInformations,
)
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.BasicAllianceInformations import (
        BasicAllianceInformations,
    )
    from com.ankamagames.dofus.network.types.game.context.roleplay.BasicGuildInformations import (
...
class CharacterMinimalAllianceInformations(CharacterMinimalGuildInformations):
    ...
    def init(
        self,
        alliance_: "BasicAllianceInformations",
