from com.ankamagames.dofus.network.types.game.prism.PrismInformation import (
    PrismInformation,
)
...
class AllianceInsiderPrismInformation(PrismInformation):
    ...
    def init(
        self,
        lastTimeSlotModificationDate_: int,
        lastTimeSlotModificationAuthorGuildId_: int,
        lastTimeSlotModificationAuthorId_: int,
        lastTimeSlotModificationAuthorName_: str,
        modulesObjects_: list["ObjectItem"],
        typeId_: int,
        state_: int,
        nextVulnerabilityDate_: int,
        placementDate_: int,
        rewardTokenCount_: int,
    ):
        self.lastTimeSlotModificationDate = lastTimeSlotModificationDate_
        self.lastTimeSlotModificationAuthorGuildId = (
            lastTimeSlotModificationAuthorGuildId_
        )
        ...
        super().__init__(
            typeId_, state_, nextVulnerabilityDate_, placementDate_, rewardTokenCount_
        )
