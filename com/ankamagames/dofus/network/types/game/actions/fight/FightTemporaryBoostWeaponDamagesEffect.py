...
class FightTemporaryBoostWeaponDamagesEffect(FightTemporaryBoostEffect):
    ...
    def init(self, weaponTypeId_:int, delta_:int, uid_:int, targetId_:int, turnDuration_:int, dispelable_:int, spellId_:int, effectId_:int, parentBoostUid_:int):
        self.weaponTypeId = weaponTypeId_
