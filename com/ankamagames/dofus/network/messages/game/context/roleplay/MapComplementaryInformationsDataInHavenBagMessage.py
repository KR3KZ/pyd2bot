...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.character.CharacterMinimalInformations import (
        CharacterMinimalInformations,
    )
    from com.ankamagames.dofus.network.types.game.house.HouseInformations import (
        HouseInformations,
    )
    ...
    from com.ankamagames.dofus.network.types.game.interactive.MapObstacle import (
        MapObstacle,
    )
...
class MapComplementaryInformationsDataInHavenBagMessage(
    MapComplementaryInformationsDataMessage
):
