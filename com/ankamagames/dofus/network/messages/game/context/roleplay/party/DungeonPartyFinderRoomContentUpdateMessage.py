...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.party.DungeonPartyFinderPlayer import (
...
class DungeonPartyFinderRoomContentUpdateMessage(NetworkMessage):
    ...
    def init(
        self,
        dungeonId_: int,
        addedPlayers_: list["DungeonPartyFinderPlayer"],
        removedPlayersIds_: list[int],
    ):
