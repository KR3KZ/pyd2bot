...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.data.items.ObjectItemQuantityPriceDateEffects import (
...
class ExchangeOfflineSoldItemsMessage(NetworkMessage):
    ...
    def init(
        self,
        bidHouseItems_: list["ObjectItemQuantityPriceDateEffects"],
        merchantItems_: list["ObjectItemQuantityPriceDateEffects"],
    ):
