...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.data.items.ObjectItemToSellInHumanVendorShop import (
...
class ExchangeStartOkHumanVendorMessage(NetworkMessage):
    ...
    def init(
        self, sellerId_: int, objectsInfos_: list["ObjectItemToSellInHumanVendorShop"]
    ):
