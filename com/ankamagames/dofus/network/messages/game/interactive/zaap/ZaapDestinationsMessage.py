...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.interactive.zaap.TeleportDestination import (
        TeleportDestination,
    )
...
class ZaapDestinationsMessage(TeleportDestinationsMessage):
    ...
    def init(
        self, spawnMapId_: int, type_: int, destinations_: list["TeleportDestination"]
    ):
