...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.context.roleplay.BasicNamedAllianceInformations import (
        BasicNamedAllianceInformations,
    )
    from com.ankamagames.dofus.network.types.game.social.GuildFactSheetInformations import (
        GuildFactSheetInformations,
    )
    from com.ankamagames.dofus.network.types.game.character.CharacterMinimalGuildPublicInformations import (
...
class GuildInAllianceFactsMessage(GuildFactsMessage):
    ...
    def init(
        ...
        members_: list["CharacterMinimalGuildPublicInformations"],
    ):
