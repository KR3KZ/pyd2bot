...
if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.game.achievement.Achievement import (
        Achievement,
    )
    from com.ankamagames.dofus.network.types.game.achievement.Achievement import (
        Achievement,
...
class AchievementDetailedListMessage(NetworkMessage):
    ...
    def init(
        self,
        startedAchievements_: list["Achievement"],
        finishedAchievements_: list["Achievement"],
    ):
