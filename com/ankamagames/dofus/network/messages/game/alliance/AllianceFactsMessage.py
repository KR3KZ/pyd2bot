...
if TYPE_CHECKING:
    ...
    from com.ankamagames.dofus.network.types.game.context.roleplay.GuildInAllianceInformations import (
...
class AllianceFactsMessage(NetworkMessage):
    ...
    def init(
        self,
        infos_: "AllianceFactSheetInformations",
        guilds_: list["GuildInAllianceInformations"],
