from com.ankamagames.dofus.network.messages.game.chat.ChatClientPrivateMessage import (
...
if TYPE_CHECKING:
    ...
    from com.ankamagames.dofus.network.types.common.AbstractPlayerSearchInformation import (
...
class ChatClientPrivateWithObjectMessage(ChatClientPrivateMessage):
    ...
    def init(
        self,
        objects_: list["ObjectItem"],
        receiver_: "AbstractPlayerSearchInformation",
        content_: str,
    ):
