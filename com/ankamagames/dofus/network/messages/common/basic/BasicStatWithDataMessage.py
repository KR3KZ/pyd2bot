from com.ankamagames.dofus.network.messages.common.basic.BasicStatMessage import (
    BasicStatMessage,
)
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from com.ankamagames.dofus.network.types.common.basic.StatisticData import (
        StatisticData,
    )
