...
from com.ankamagames.dofus.logic.game.common.managers.StorageOptionManager import StorageOptionManager
from com.ankamagames.dofus.logic.game.common.misc.inventoryView.StorageGenericView import StorageGenericView
from com.ankamagames.dofus.types.enums.ItemCategoryEnum import ItemCategoryEnum

class BankQuestView(StorageGenericView):
