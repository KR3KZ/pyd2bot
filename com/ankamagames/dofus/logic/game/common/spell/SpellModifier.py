...
class SpellModifier:
   ...
   def __str__(self) -> str:
      return self.__class__.__name__ + " " + self._name + " (Entity ID: " + str(self._entityId) + ", Spell ID: " + str(self._spellId) + ", ID: " + str(self._id) + "): " + "base: " + str(self._baseValue) + " additional: " + str(self._additionalValue) + " objectsAndMountBonus: " + str(self._objectsAndMountBonusValue) + " alignGiftBonus: " + str(self._alignGiftBonusValue) + " contextModif: " + str(self._contextModifValue) + " total: " + str(self._totalValue)
