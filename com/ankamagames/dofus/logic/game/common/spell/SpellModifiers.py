...
from com.ankamagames.dofus.logic.game.fight.actions.UpdateSpellModifierAction import UpdateSpellModifierAction
...
class SpellModifiers:
   ...
   def getFormattedMessage(self, message:str) -> str:
      return self.__class__.__name__ + " (Entity ID: " + str(self._entityId) + ", Spell ID: " + str(self._spellId) + "): " + message
   ...
   def setModifier(self, modifier:SpellModifier) -> None:
      ...
      if self.isVerbose:
         logger.info("Set modifier for entity with ID " + str(self.entityId) + " and spell with ID " + str(self.spellId) + ": " + str(modifier))
   ...
   def deleteModifier(self, modifierId:float) -> None:
      ...
      if self.isVerbose:
         logger.info("Deleted modifier for entity with ID " + str(self._entityId) + " and spell with ID " + str(self._spellId) + ": " + str(modifier))
      del self._modifiers[modifierKey]
   
   def resetModifiers(self) -> None:
      if self.isVerbose:
         logger.info("Modifiers reset for entity with ID " + str(self._entityId) + " and spell with ID " + str(self._spellId))
      self._modifiers = dict()
