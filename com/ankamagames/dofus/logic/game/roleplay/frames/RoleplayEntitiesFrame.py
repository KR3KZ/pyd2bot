...
class RoleplayEntitiesFrame(AbstractEntitiesFrame, Frame):
    ...
    def process(self, msg: Message):
        ...
        if isinstance(msg, MapComplementaryInformationsDataMessage):
            ...
            if PlayedCharacterManager().isInHouse and not isinstance(msg, MapComplementaryInformationsDataInHouseMessage):
                PlayedCharacterManager().isInHouse = False
                PlayedCharacterManager().isInHisHouse = False
                
            if PlayedCharacterManager().isIndoor and not isinstance(msg, MapComplementaryInformationsWithCoordsMessage):
            ...
            if isinstance(msg, MapComplementaryInformationsWithCoordsMessage):
                ...
                mcidihmsg = msg
                isPlayerHouse = PlayerManager().nickname == mcidihmsg.currentHouse.houseInfos.ownerTag.nickname and\
                     PlayerManager().tag == mcidihmsg.currentHouse.houseInfos.ownerTag.tagNumber
