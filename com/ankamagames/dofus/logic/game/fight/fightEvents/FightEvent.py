...
class FightEvent:
   ...
   def __init__(self, pName:str, pParams:list, pTargetId:float, pCheckParams:int, pCastingSpellId:int, pOrder:int = -1, pFirstParamToCheck:int = 1, pBuff:BasicBuff = None):
      super().__init__()
      self.name = pName
