...
class BasicCharacterWrapper(IDataCenter):
   ...
   def create(self, id:float, name:str, level:int, entityLook:EntityLook, breed:int, sex:bool, deathState:int = 0, deathCount:int = 0, deathMaxLevel:int = 0, bonusXp:int = 0, unusable:bool = False) -> 'BasicCharacterWrapper':
