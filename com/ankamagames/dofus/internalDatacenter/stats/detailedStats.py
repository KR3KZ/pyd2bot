...
class DetailedStat(Stat):
   ...
   def __init__(self, id:float, baseValue:float, additionalValue:float, objectsAndMountBonusValue:float, alignGiftBonusValue:float, contextModifValue:float):
      ...
      super(id,self._baseValue + self._additionalValue + self._objectsAndMountBonusValue + self._alignGiftBonusValue + self._contextModifValue)
   ...
   def __str__(self) -> str:
      return self.getFormattedMessage("base: " + self._baseValue.__str__() + " additional: " + self._additionalValue.__str__() + " objectsAndMountBonus: " + self._objectsAndMountBonusValue.__str__() + " alignGiftBonus: " + self._alignGiftBonusValue.__str__() + " contextModif: " + self._contextModifValue.__str__() + " total: " + self._totalValue.__str__())
   
   def reset(self) -> None:
      self._baseValue = self._additionalValue = self._objectsAndMountBonusValue = self._alignGiftBonusValue = self._contextModifValue = _totalValue = 0
   
   def updateTotal(self) -> None:
      self._totalValue = self._baseValue + self._additionalValue + self._objectsAndMountBonusValue + self._alignGiftBonusValue + self._contextModifValue
