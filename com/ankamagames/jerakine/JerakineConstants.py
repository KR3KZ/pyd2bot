...
DATASTORE_CLASS_ALIAS:DataStoreType = DataStoreType("Jerakine_classAlias", True, DataStoreEnum.LOCATION_LOCAL, DataStoreEnum.BIND_COMPUTER)

DATASTORE_LANG:DataStoreType = DataStoreType("Jerakine_lang",True,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER)

DATASTORE_LANG_VERSIONS:DataStoreType = DataStoreType("Jerakine_lang_vesrion",True,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER)

DATASTORE_FILES_INFO:DataStoreType = DataStoreType("Jerakine_file_version",True,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER)

DATASTORE_MD5:DataStoreType = DataStoreType("Jerakine_md5",True,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER)

DATASTORE_GAME_DATA:DataStoreType = DataStoreType("Jerakine_gameData",True,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER)
