...
class Treatment:
      ...
      def isSameTreatment(self, object, func:FunctionType, params:list) -> bool:
         if object != self._object or func != self._calledFunctionType or len(self._params) != len(params):
            return False
      ...
      def isCloseTreatment(self, object, func:FunctionType, params:list) -> bool:
         param = None
         if object and object != self._object or func and func != self._calledFunctionType:
            return False
         for param in params:
