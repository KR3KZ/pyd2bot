...
class Version(IExternalizable, IDataCenter):
   ...
   def __init__(self, *args):
      ...
      if not args or len(args) == 0:
         ...
         self._code = int(split[2].split("-")[0])
         self._buildType = args[1]
   
   def fromServerData(self, major:int, minor:int, code:int, build:int, buildType:int) -> 'Version':
   ...
   def __str__(self) -> str:
      if self._buildType == 5:
         return self._major + "." + self._minor + "." + self._code
      if self._buildType == 0:
         return self._major + "." + self._minor + "." + self._code + "." + self._build
      return self._major + "." + self._minor + "." + self._code + "." + self._build + "-" + self._buildType
   ...
   def equals(self, otherVersion:'Version') -> bool:
      return self._major == otherVersion._major and self._minor == otherVersion._minor and self._code == otherVersion._code and self._build == otherVersion._build and self._buildType == otherVersion._buildType
